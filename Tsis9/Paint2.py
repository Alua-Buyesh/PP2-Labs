...
pencil = pygame.image.load('Music and png/pencil.png')
...
bucket = pygame.image.load('Music and png/bucket (1).png')
bucket = pygame.transform.scale(bucket, (75, 75))

eraser = pygame.image.load('Music and png/eraser.png')
eraser = pygame.transform.scale(eraser, (75, 75))

figures = pygame.image.load('Music and png/figures.png')
figures = pygame.transform.scale(figures, (75, 75))

pallete = pygame.image.load('Music and png/palette.png')
